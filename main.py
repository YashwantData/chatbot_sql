...
def main(key):
    if key:
        ...
        db_url_1 = os.environ.get('DB_CONNECTION','mssql+pyodbc://DESKTOP-SVULHV9\SQLEXPRESS/AdventureWorksLT2022?trusted_connection=yes&driver=ODBC+Driver+17+for+SQL+Server')
